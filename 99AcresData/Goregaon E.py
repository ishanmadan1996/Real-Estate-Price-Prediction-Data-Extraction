...
urls_page = ['https://www.99acres.com/property-in-goregaon-east-mumbai-andheri-dahisar-ffid-page-'+
             str(i) for i in range(1, 39)] #pagenation links

with open('C:\Users\Ishant\Desktop\\' + 'Goregaon(East).csv', 'a') as f:
    writer = csv.writer(f)
    ...
    try:
        ...
        for span in ab: #go through all links found on the page
            try:
                ...
                with open('C:\Users\Ishant\Desktop\\' + 'log_Goregaon(East).csv', 'a') as f1:

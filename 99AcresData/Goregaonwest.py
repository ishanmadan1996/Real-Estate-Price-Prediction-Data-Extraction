...
with open('/home/ubuntu/99acres/' + 'Goregaon(West).csv', 'a') as f:
    writer = csv.writer(f)
    ...
    try:
        ...
        for span in ab: #go through all links found on the page
            try:
                ...
                with open('/home/ubuntu/99acres/logs/' + 'log_Goregaon(West).csv', 'a') as f1:
                         f1.write(str(url_extension+i['href'])+'\n')
                         f1.close()
    except Exception as e1:
        with open('/home/ubuntu/99acres/logs/' + 'log_Goregaon(West)_pagelinks.csv', 'a') as f1:
            f1.write(str(x) + '\n')
            f1.close()
